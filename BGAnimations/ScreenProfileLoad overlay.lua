...
return Def.ActorFrame{
	...
	Def.Quad{
		...
		InitCommand=function(self)
			...
			self:diffuse( ThemePrefs.Get("RainbowMode") and Color.White or Color.Black ):diffusealpha(1)
		end,
	...
	Def.BitmapText{
		...
		InitCommand=function(self)
			self:diffuse( ThemePrefs.Get("RainbowMode") and Color.White or Color.Black ):zoom(0.1)
		end
	}
}