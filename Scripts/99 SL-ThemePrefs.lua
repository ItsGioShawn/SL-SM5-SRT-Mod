local SL_CustomPrefs =
{
	...
	DefaultLevel =
	{
		Default = "LV1",
		Choices = {
			THEME:GetString("ScreenSelectLevel", "LV1"),
			THEME:GetString("ScreenSelectLevel", "LV2"),
			THEME:GetString("ScreenSelectLevel", "LV3"),
			THEME:GetString("ScreenSelectLevel", "LV4")
		},
		Values 	= { "LV1", "LV2", "LV3", "LV4" }
	},
	TimingWindowAdd = {
		Default = 0,
		Choices = { 0, 0.0015 },
